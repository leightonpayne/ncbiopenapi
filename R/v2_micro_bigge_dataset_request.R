#' Create a new V2MicroBiggeDatasetRequest
#'
#' @description
#' V2MicroBiggeDatasetRequest Class
#'
#' @docType class
#' @title V2MicroBiggeDatasetRequest
#' @description V2MicroBiggeDatasetRequest Class
#' @format An \code{R6Class} generator object
#' @field opaque_solr_query  character [optional]
#' @field files  list(\link{V2MicroBiggeDatasetRequestFileType}) [optional]
#' @field element_flank_config  \link{V2ElementFlankConfig} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
V2MicroBiggeDatasetRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new V2MicroBiggeDatasetRequest class.
    #'
    ...
    #'
    #' @return V2MicroBiggeDatasetRequest as a base R list.
    #' @examples
    #' # convert array of V2MicroBiggeDatasetRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert V2MicroBiggeDatasetRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      V2MicroBiggeDatasetRequestObject <- list()
      if (!is.null(self$`opaque_solr_query`)) {
        V2MicroBiggeDatasetRequestObject[["opaque_solr_query"]] <-
          self$`opaque_solr_query`
      }
      if (!is.null(self$`files`)) {
        V2MicroBiggeDatasetRequestObject[["files"]] <-
          lapply(self$`files`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`element_flank_config`)) {
        V2MicroBiggeDatasetRequestObject[["element_flank_config"]] <-
          self$`element_flank_config`$toSimpleType()
      }
      return(V2MicroBiggeDatasetRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of V2MicroBiggeDatasetRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of V2MicroBiggeDatasetRequest
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`files`)) {
        self$`files` <- ApiClient$new()$deserializeObj(this_object$`files`, "array[V2MicroBiggeDatasetRequestFileType]", loadNamespace("ncbiopenapi"))
      }
    ...
    #' @return V2MicroBiggeDatasetRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to V2MicroBiggeDatasetRequest and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of V2MicroBiggeDatasetRequest
    toString = function() {
      self$toJSONString()
    },
...
# V2MicroBiggeDatasetRequest$unlock()
#
## Below is an example to define the print function
# V2MicroBiggeDatasetRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# V2MicroBiggeDatasetRequest$lock()
