#' Create a new V2reportsGeneDataReportPage
#'
#' @description
#' V2reportsGeneDataReportPage Class
#'
#' @docType class
#' @title V2reportsGeneDataReportPage
#' @description V2reportsGeneDataReportPage Class
#' @format An \code{R6Class} generator object
#' @field reports  list(\link{V2reportsGeneReportMatch}) [optional]
...
#' @export
V2reportsGeneDataReportPage <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new V2reportsGeneDataReportPage class.
    #'
    ...
    #'
    #' @return V2reportsGeneDataReportPage as a base R list.
    #' @examples
    #' # convert array of V2reportsGeneDataReportPage (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert V2reportsGeneDataReportPage to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      V2reportsGeneDataReportPageObject <- list()
      if (!is.null(self$`reports`)) {
        V2reportsGeneDataReportPageObject[["reports"]] <-
          lapply(self$`reports`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`messages`)) {
        V2reportsGeneDataReportPageObject[["messages"]] <-
          lapply(self$`messages`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`total_count`)) {
        V2reportsGeneDataReportPageObject[["total_count"]] <-
          self$`total_count`
      }
      if (!is.null(self$`next_page_token`)) {
        V2reportsGeneDataReportPageObject[["next_page_token"]] <-
          self$`next_page_token`
      }
      return(V2reportsGeneDataReportPageObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of V2reportsGeneDataReportPage
    #'
    #' @param input_json the JSON input
    #' @return the instance of V2reportsGeneDataReportPage
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`reports`)) {
        self$`reports` <- ApiClient$new()$deserializeObj(this_object$`reports`, "array[V2reportsGeneReportMatch]", loadNamespace("ncbiopenapi"))
      }
    ...
    #' @return V2reportsGeneDataReportPage in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to V2reportsGeneDataReportPage and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of V2reportsGeneDataReportPage
    toString = function() {
      self$toJSONString()
    },
...
# V2reportsGeneDataReportPage$unlock()
#
## Below is an example to define the print function
# V2reportsGeneDataReportPage$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# V2reportsGeneDataReportPage$lock()
