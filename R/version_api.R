...
VersionApi <- R6::R6Class(
  ...
  public = list(
    ...
    Version = function(data_file = NULL, ...) {
      local_var_response <- self$VersionWithHttpInfo(data_file = data_file, ...)
    ...
    #' @param ... Other optional arguments
    #'
    #' @return API response (V2VersionReply) with additional information such as HTTP status code, headers
    VersionWithHttpInfo = function(data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "V2VersionReply"),
          error = function(e) {
