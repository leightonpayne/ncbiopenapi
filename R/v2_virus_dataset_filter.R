#' Create a new V2VirusDatasetFilter
#'
#' @description
#' V2VirusDatasetFilter Class
#'
#' @docType class
#' @title V2VirusDatasetFilter
#' @description V2VirusDatasetFilter Class
...
#' @export
V2VirusDatasetFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new V2VirusDatasetFilter class.
    #'
    ...
    #'
    #' @return V2VirusDatasetFilter as a base R list.
    #' @examples
    #' # convert array of V2VirusDatasetFilter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert V2VirusDatasetFilter to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      V2VirusDatasetFilterObject <- list()
      if (!is.null(self$`accessions`)) {
        V2VirusDatasetFilterObject[["accessions"]] <-
          self$`accessions`
      }
      if (!is.null(self$`taxon`)) {
        V2VirusDatasetFilterObject[["taxon"]] <-
          self$`taxon`
      }
      if (!is.null(self$`taxons`)) {
        V2VirusDatasetFilterObject[["taxons"]] <-
          self$`taxons`
      }
      if (!is.null(self$`refseq_only`)) {
        V2VirusDatasetFilterObject[["refseq_only"]] <-
          self$`refseq_only`
      }
      if (!is.null(self$`annotated_only`)) {
        V2VirusDatasetFilterObject[["annotated_only"]] <-
          self$`annotated_only`
      }
      if (!is.null(self$`released_since`)) {
        V2VirusDatasetFilterObject[["released_since"]] <-
          self$`released_since`
      }
      if (!is.null(self$`updated_since`)) {
        V2VirusDatasetFilterObject[["updated_since"]] <-
          self$`updated_since`
      }
      if (!is.null(self$`host`)) {
        V2VirusDatasetFilterObject[["host"]] <-
          self$`host`
      }
      if (!is.null(self$`pangolin_classification`)) {
        V2VirusDatasetFilterObject[["pangolin_classification"]] <-
          self$`pangolin_classification`
      }
      if (!is.null(self$`geo_location`)) {
        V2VirusDatasetFilterObject[["geo_location"]] <-
          self$`geo_location`
      }
      if (!is.null(self$`usa_state`)) {
        V2VirusDatasetFilterObject[["usa_state"]] <-
          self$`usa_state`
      }
      if (!is.null(self$`complete_only`)) {
        V2VirusDatasetFilterObject[["complete_only"]] <-
          self$`complete_only`
      }
      return(V2VirusDatasetFilterObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of V2VirusDatasetFilter
    #'
    #' @param input_json the JSON input
    #' @return the instance of V2VirusDatasetFilter
    ...
    #' @return V2VirusDatasetFilter in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to V2VirusDatasetFilter and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of V2VirusDatasetFilter
    toString = function() {
      self$toJSONString()
    },
...
# V2VirusDatasetFilter$unlock()
#
## Below is an example to define the print function
# V2VirusDatasetFilter$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# V2VirusDatasetFilter$lock()
