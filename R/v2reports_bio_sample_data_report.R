#' Create a new V2reportsBioSampleDataReport
#'
#' @description
#' V2reportsBioSampleDataReport Class
#'
#' @docType class
#' @title V2reportsBioSampleDataReport
#' @description V2reportsBioSampleDataReport Class
...
#' @export
V2reportsBioSampleDataReport <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new V2reportsBioSampleDataReport class.
    #'
    ...
    #'
    #' @return V2reportsBioSampleDataReport as a base R list.
    #' @examples
    #' # convert array of V2reportsBioSampleDataReport (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert V2reportsBioSampleDataReport to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      V2reportsBioSampleDataReportObject <- list()
      if (!is.null(self$`accession`)) {
        V2reportsBioSampleDataReportObject[["accession"]] <-
          self$`accession`
      }
      if (!is.null(self$`last_updated`)) {
        V2reportsBioSampleDataReportObject[["last_updated"]] <-
          self$`last_updated`
      }
      if (!is.null(self$`publication_date`)) {
        V2reportsBioSampleDataReportObject[["publication_date"]] <-
          self$`publication_date`
      }
      if (!is.null(self$`submission_date`)) {
        V2reportsBioSampleDataReportObject[["submission_date"]] <-
          self$`submission_date`
      }
      if (!is.null(self$`sample_ids`)) {
        V2reportsBioSampleDataReportObject[["sample_ids"]] <-
          lapply(self$`sample_ids`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`description`)) {
        V2reportsBioSampleDataReportObject[["description"]] <-
          self$`description`$toSimpleType()
      }
      if (!is.null(self$`owner`)) {
        V2reportsBioSampleDataReportObject[["owner"]] <-
          self$`owner`$toSimpleType()
      }
      if (!is.null(self$`models`)) {
        V2reportsBioSampleDataReportObject[["models"]] <-
          self$`models`
      }
      if (!is.null(self$`bioprojects`)) {
        V2reportsBioSampleDataReportObject[["bioprojects"]] <-
          lapply(self$`bioprojects`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`package`)) {
        V2reportsBioSampleDataReportObject[["package"]] <-
          self$`package`
      }
      if (!is.null(self$`attributes`)) {
        V2reportsBioSampleDataReportObject[["attributes"]] <-
          lapply(self$`attributes`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`status`)) {
        V2reportsBioSampleDataReportObject[["status"]] <-
          self$`status`$toSimpleType()
      }
      if (!is.null(self$`age`)) {
        V2reportsBioSampleDataReportObject[["age"]] <-
          self$`age`
      }
      if (!is.null(self$`biomaterial_provider`)) {
        V2reportsBioSampleDataReportObject[["biomaterial_provider"]] <-
          self$`biomaterial_provider`
      }
      if (!is.null(self$`breed`)) {
        V2reportsBioSampleDataReportObject[["breed"]] <-
          self$`breed`
      }
      if (!is.null(self$`collected_by`)) {
        V2reportsBioSampleDataReportObject[["collected_by"]] <-
          self$`collected_by`
      }
      if (!is.null(self$`collection_date`)) {
        V2reportsBioSampleDataReportObject[["collection_date"]] <-
          self$`collection_date`
      }
      if (!is.null(self$`cultivar`)) {
        V2reportsBioSampleDataReportObject[["cultivar"]] <-
          self$`cultivar`
      }
      if (!is.null(self$`dev_stage`)) {
        V2reportsBioSampleDataReportObject[["dev_stage"]] <-
          self$`dev_stage`
      }
      if (!is.null(self$`ecotype`)) {
        V2reportsBioSampleDataReportObject[["ecotype"]] <-
          self$`ecotype`
      }
      if (!is.null(self$`geo_loc_name`)) {
        V2reportsBioSampleDataReportObject[["geo_loc_name"]] <-
          self$`geo_loc_name`
      }
      if (!is.null(self$`host`)) {
        V2reportsBioSampleDataReportObject[["host"]] <-
          self$`host`
      }
      if (!is.null(self$`host_disease`)) {
        V2reportsBioSampleDataReportObject[["host_disease"]] <-
          self$`host_disease`
      }
      if (!is.null(self$`identified_by`)) {
        V2reportsBioSampleDataReportObject[["identified_by"]] <-
          self$`identified_by`
      }
      if (!is.null(self$`ifsac_category`)) {
        V2reportsBioSampleDataReportObject[["ifsac_category"]] <-
          self$`ifsac_category`
      }
      if (!is.null(self$`isolate`)) {
        V2reportsBioSampleDataReportObject[["isolate"]] <-
          self$`isolate`
      }
      if (!is.null(self$`isolate_name_alias`)) {
        V2reportsBioSampleDataReportObject[["isolate_name_alias"]] <-
          self$`isolate_name_alias`
      }
      if (!is.null(self$`isolation_source`)) {
        V2reportsBioSampleDataReportObject[["isolation_source"]] <-
          self$`isolation_source`
      }
      if (!is.null(self$`lat_lon`)) {
        V2reportsBioSampleDataReportObject[["lat_lon"]] <-
          self$`lat_lon`
      }
      if (!is.null(self$`project_name`)) {
        V2reportsBioSampleDataReportObject[["project_name"]] <-
          self$`project_name`
      }
      if (!is.null(self$`sample_name`)) {
        V2reportsBioSampleDataReportObject[["sample_name"]] <-
          self$`sample_name`
      }
      if (!is.null(self$`serovar`)) {
        V2reportsBioSampleDataReportObject[["serovar"]] <-
          self$`serovar`
      }
      if (!is.null(self$`sex`)) {
        V2reportsBioSampleDataReportObject[["sex"]] <-
          self$`sex`
      }
      if (!is.null(self$`source_type`)) {
        V2reportsBioSampleDataReportObject[["source_type"]] <-
          self$`source_type`
      }
      if (!is.null(self$`strain`)) {
        V2reportsBioSampleDataReportObject[["strain"]] <-
          self$`strain`
      }
      if (!is.null(self$`sub_species`)) {
        V2reportsBioSampleDataReportObject[["sub_species"]] <-
          self$`sub_species`
      }
      if (!is.null(self$`tissue`)) {
        V2reportsBioSampleDataReportObject[["tissue"]] <-
          self$`tissue`
      }
      if (!is.null(self$`serotype`)) {
        V2reportsBioSampleDataReportObject[["serotype"]] <-
          self$`serotype`
      }
      return(V2reportsBioSampleDataReportObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of V2reportsBioSampleDataReport
    #'
    #' @param input_json the JSON input
    #' @return the instance of V2reportsBioSampleDataReport
    ...
    #' @return V2reportsBioSampleDataReport in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to V2reportsBioSampleDataReport and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of V2reportsBioSampleDataReport
    toString = function() {
      self$toJSONString()
    },
...
# V2reportsBioSampleDataReport$unlock()
#
## Below is an example to define the print function
# V2reportsBioSampleDataReport$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# V2reportsBioSampleDataReport$lock()
