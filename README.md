...
```sh
git clone https://github.com/leightonpayne/ncbiopenapi
cd ncbiopenapi
R CMD build .
R CMD check ncbiopenapi_1.0.0.tar.gz --no-manual
R CMD INSTALL --preclean ncbiopenapi_1.0.0.tar.gz
```

### Install the package

```R
install.packages("ncbiopenapi")
```
...
library(devtools)
install_github("leightonpayne/ncbiopenapi")
```

To install the package from a local file:
```R
install.packages("ncbiopenapi_1.0.0.tar.gz", repos = NULL, type = "source")
```
